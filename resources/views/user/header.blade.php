        ...
        <div class="container">
            <div class="header-wrap">
                <div class="logo logo-width-1">
                    <a href="/"><img src="{{asset('user/assets/imgs/logo/app_logo.png')}}" alt="logo"></a>
                </div>
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <div class="shopping-cart-img">
                                                        <a href="{{url('product_details',$cart->product_id)}}"><img alt="Product Image" src="{{asset('products_images/'. $cart->image)}}"></a>
                                                    </div>
        ...
        <div class="container">
            <div class="header-wrap header-space-between position-relative">
                <div class="logo logo-width-1 d-block d-lg-none">
                    <a href="index.html"><img src="{{asset('user/assets/imgs/logo/app_logo.png')}}" alt="logo"></a>
                </div>
                <div class="header-nav d-none d-lg-flex">
                    <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block">
                        <nav>
                            <ul>
                                <li><a class="{{Route::is('user.home')? 'active' : ''}}" href="{{url('/')}}">Home </a></li>
                                <li><a class="{{Route::is('shopping')? 'active' : ''}}" href="{{route('shopping')}}">Shopping</a></li>
                                <li><a class="{{Route::is('to-lets')? 'active' : ''}}" href="{{route('to-lets')}}">To-Let</a></li>
                                <li><a class="{{Route::is('user.contact')? 'active' : ''}}" href="{{route('user.contact')}}">Contact</a></li>
                                @if (auth()->check() && auth()->user()->usertype === 0)
                                    @auth
                                        <li><a href="{{route('user.dashboard')}}">My Account<i class="fi-rs-angle-down"></i></a>
                                            <ul class="sub-menu">
                ...
                <div class="hotline d-none d-lg-block">
                    <p><i class="fi-rs-smartphone"></i><span>Toll Free</span> (+880) 1748 xxxxxx </p>
                </div>
            </div>
        </div>
    </div>
