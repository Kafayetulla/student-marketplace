    ...
    <div class="row">
        <div class="col-12 grid-margin">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-9"><h4 class="card-title">Product details</h4></div>
                        <div class="col-md-3 text-right"><a href="{{route('user.products.index')}}" class="btn btn-primary"><i class="fi-rs-arrow-left"></i> Product List</a></div>
                    </div>
                    <div class="row">
