...
@section('dashboard.content')
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-9"><h4 class="card-title">All Products</h4></div>
                    <div class="col-md-3 text-right"><a href="{{route('user.products.create')}}" class="btn btn-primary"><i class="fi-rs-plus"></i> Create Product </a></div>
                </div>
                        ...
                        @forelse($products as $product)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('user.products.edit',$product->id)}}" class="mr-3"
