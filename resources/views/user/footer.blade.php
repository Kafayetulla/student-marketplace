            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="widget-about font-md mb-md-5 mb-lg-0">
                        ...
                        <p class="wow fadeIn animated">
                            <strong>Phone: </strong>+8801748xxxxxx
                        </p>
                        <p class="wow fadeIn animated">
                            <strong>Email: </strong>contact@student-marketplace.com
                        </p>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <p class="text-lg-end text-start font-sm text-muted mb-0">
                    &copy; <strong class="text-brand">Student Marketplace</strong> All rights reserved
                </p>
            </div>
        </div>
    </div>
