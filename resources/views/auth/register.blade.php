                                    ...
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <form method="post" action="{{ route('register') }}">
                                            ...
                                            <div class="form-group">
                                                <input type="text" required name="name" placeholder="Name" value value="{{ old('name') }}">
                                            </div>
                                            <div class="form-group">
                                                <input type="text" required name="email" placeholder="Email" value="{{ old('email') }}">
                                            </div>
                                            <div class="form-group">
                                                <input type="number" required name="phone" placeholder="Phone Number" value="{{ old('phone') }}">
                                            </div>
                                            <div class="form-group">
