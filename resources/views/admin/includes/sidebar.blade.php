    ...
    <ul class="nav">
        ...
        <li class="nav-item menu-items">
            <a class="nav-link" data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
              ...
              <span class="menu-title">To-Lets</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{route('admin.to-lets.create')}}">Add To-Let</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{route('admin.to-lets.index')}}">All To-Lets</a></li>
              </ul>
            </div>
        </li>
{{--        <li class="nav-item menu-items">--}}
