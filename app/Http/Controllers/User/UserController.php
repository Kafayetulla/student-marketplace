...
class UserController extends Controller
{
    public function dashboard()
    {
        ...
        return view('user.dashboard.dashboard', compact('user', 'cartData'));
    }
    ...
    public function address()
    {
        $user = Auth::user();
        $cartData = Cart::where('user_id', $user->id)->get();
        return view('user.dashboard.address', compact('user', 'cartData'));
    }
    ...
    public function details()
    {
        $user = Auth::user();
        $cartData = Cart::where('user_id', $user->id)->get();
        return view('user.dashboard.details', compact('user', 'cartData'));
    }
